...
const DiagramApp = (props) => {
  ...
  class DiagramApp extends Component {
    ...
    constructor(props) {
      ...
      // mf.Diagramming.SvgNode.prototype.onUpdateVisuals = function () {
      ...
      // node.width = 49;
      // // Custom Arrow head
      // Object.values(nodeDict2).forEach((dict) => {
      //   const arrowHead = new mf.Diagramming.SvgNode(diagram);
      //   // arrowHead.setBounds(new cm.Drawing.Rect(25, 15, 60, 25));
      //   arrowHead.setContent(dict.content);
      //   // arrowHead.setShape(dict.content);
      //   arrowHeadNodes.push(arrowHead);
      //   arrowHeadIds.push(dict.name);
      //   // arrowHead.setShape(arrowHead);
      // });
    ...
    render() {
      ...
      const detail = () => {
        ...
        nodes.forEach((node) => {
          ...
          //   node.text.padding.left = 1;
          // }
          // console.log((node.text.lineAlignment = 0));
          // console.log((node.text.textAlignment = 0));
          // console.log((node.text.padding.top = 3));
          // console.log((node.text.padding.left = 8));
            ...
            if (origin.content.fileName == "/static/media/Goal.ce4d68d3.svg") {
              ...
              if (link.brush == "black") {
                if (
                  ...
                  a = 1;
                  console.log("supportedBy cannot connect to Contex");
                } else if (
                  destination.content.fileName ==
                  "/static/media/Assumption.d31ca3ab.svg"
                ) {
      ...
      const CAEToGSN = () => {
        try {
          ...
          nodes.forEach((node) => {
            ...
            // for(var i =0;i<2;i++){
            // newNode.onUpdateVisuals = function () {
            //   var Alignment = mf.Diagramming.Alignment;
            //   var Text = mf.Drawing.Text;
            //   var content = this.graphicsContainer.content;
            //   var rect = this.getBounds().clone();
            ...
            //   // idNum += 1;
            // };
            // var content = newNode.graphicsContainer.content;
            // var extraText = new Text(
            //   "G" + Nomer // replace with this.yourFieldName // this.getBounds().clone()
            // );
            // content.push(extraText);
      ...
      const GSNToSACM = () => {
        try {
          ...
          nodes.forEach((node) => {
            ...
            // else if (
            //   node.content.fileName == "/static/media/Claim.65db5c64.svg"
            // ) {
            //   nodes = ValidateSACM();
            // }
          ...
          <div className="main">
            <div className="topbar">
              ...
              <div>
                ...
                <button className="button" id="test button" onClick={GSNToSACM}>
                  GSN &#8596; SACM
                </button>
            ...
            <div className="diagram-area">
              <DiagramView
                ...
                onNodeCreated={(diagram, args) => {
                  ...
                  // new mf.Drawing.Size(42, 23);
                  // buat yang kotak 48,24.75208333333333
                  // buat yang bulet 32,32.05208333333333
                  // buat strategy 49.6375,24.66979166666667
                  // buat context 44,24.75208333333333
                  // buat yang oval 43.75208333333333,28.171875
                  this.nodeSize(node);
                  // console.log(node);
                  // this.diagramId(diagram, args);
